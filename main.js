...
function drawFrame(){
    ...
    strokeWeight(3);
    // Outer Circle
    line(pen.flx - 60, 160, pen.frx + 60, 160);
    line(pen.flx - 60, 160, pen.flx - 60, 160 + pen.length + logo.h + 32 + 60);
    line(pen.frx + 60, 160, pen.frx + 60, 160 + pen.length + logo.h + 32 + 60);
    line(pen.flx - 60, 160 + pen.length + logo.h + 32 + 60, pen.frx + 60, 160 + pen.length + logo.h + 32 + 60);
    // Inner Circle
    line(pen.flx - 40, 190, pen.frx + 40, 190);
    line(pen.flx - 40, 160 + pen.length + logo.h + 32 + 32, pen.frx + 40, 160 + pen.length + logo.h + 32 + 32);
    line(pen.flx - 40, 190, pen.flx - 40, 160 + pen.length + logo.h + 32 + 32);
    line(pen.frx + 40, 190, pen.frx + 40, 160 + pen.length + logo.h + 32 + 32);
